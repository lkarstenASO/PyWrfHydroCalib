...
def createHrldasNL(statusData,gageData,jobData,outDir,typeFlag,bDate,eDate,genFlag):
    ...
    try:
        ...
        fileObj.write('\n')
        fileObj.write('! Forcing input variable names\n')
        fileObj.write('forcing_name_T = "T2D"\n')
        fileObj.write('forcing_name_Q = "Q2D"\n')
        fileObj.write('forcing_name_U = "U2D"\n')
        fileObj.write('forcing_name_V = "V2D"\n')
        fileObj.write('forcing_name_P = "PSFC"\n')
        fileObj.write('forcing_name_LW = "LWDOWN"\n')
        fileObj.write('forcing_name_SW = "SWDOWN"\n')
        fileObj.write('forcing_name_PR = "RAINRATE"\n')
        fileObj.write('forcing_name_SN = ""\n')
        fileObj.write('forcing_name_LF = "LQFRAC"\n')
        fileObj.write('\n')
        fileObj.write('/\n')
        fileObj.write('\n')
